...
(16, 'menu:update', '更新菜单'),
(17, 'menu:delete', '删除菜单'),
(18, 'adminlog:view', '操作日志列表'),
(19, 'adminlog:delete', '删除操作日志');

-- 游戏管理权限
INSERT INTO permissions (id, name, description) VALUES
(19, 'game', '游戏管理'),
(20, 'gamelog:view', '游戏日志列表'),
...
(27, 'file:view', '文件列表'),
(28, 'file:ftp', 'FTP上传'),
(29, 'serverconf:view', '服务器配置'),
(30, 'tools:terminal', '命令执行'),
(31, 'package:view', '打包工具'),
(32, 'citask:view', '任务列表'),
...
INSERT INTO permission (name, description) VALUES ('filemanager:view', '文件管理-列表');
...
INSERT INTO permissions (name, code, description) VALUES ('查看游戏配置表', 'luban:view', '查看游戏配置表列表和详情');
...
-- 游戏配置管理权限
INSERT INTO permissions (name, code, description) VALUES ('查看游戏配置', 'gameconf:view', '查看游戏配置');
