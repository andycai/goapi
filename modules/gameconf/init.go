...
func (m *gameconfModule) AddAuthRouters() error {
	...
	// api - projects
	app.RouterApi.Get("/gameconf/projects", app.HasPermission("gameconf:list"), listProjectsHandler)           // 获取项目列表
	app.RouterApi.Post("/gameconf/projects", app.HasPermission("gameconf:create"), createProjectHandler)       // 创建项目
	app.RouterApi.Get("/gameconf/projects/:id", app.HasPermission("gameconf:list"), getProjectHandler)         // 获取项目详情
	...
	// api - tables
	app.RouterApi.Get("/gameconf/tables", app.HasPermission("gameconf:list"), listTablesHandler)                    // 获取配置表列表
	app.RouterApi.Post("/gameconf/tables", app.HasPermission("gameconf:create"), createTableHandler)                // 创建配置表
	app.RouterApi.Get("/gameconf/tables/:id", app.HasPermission("gameconf:list"), getTableHandler)                  // 获取配置表详情
	...
	// api - exports
	app.RouterApi.Get("/gameconf/exports", app.HasPermission("gameconf:list"), listExportsHandler)                 // 获取导出记录列表
	app.RouterApi.Post("/gameconf/exports", app.HasPermission("gameconf:create"), createExportHandler)             // 创建导出记录
	app.RouterApi.Get("/gameconf/exports/:id", app.HasPermission("gameconf:list"), getExportHandler)               // 获取导出记录详情
	app.RouterApi.Delete("/gameconf/exports/:id", app.HasPermission("gameconf:delete"), deleteExportHandler)       // 删除导出记录
	app.RouterApi.Get("/gameconf/exports/:id/download", app.HasPermission("gameconf:list"), downloadExportHandler) // 下载导出文件
