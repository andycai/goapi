...
func createProject(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "create", "gameconf_project", project.ID, fmt.Sprintf("创建游戏配置项目：%s", project.Name))
...
func updateProject(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "update", "gameconf_project", project.ID, fmt.Sprintf("更新游戏配置项目：%s", project.Name))
...
func deleteProject(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "delete", "gameconf_project", project.ID, fmt.Sprintf("删除游戏配置项目：%s", project.Name))
...
func createTable(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "create", "gameconf_table", table.ID, fmt.Sprintf("创建游戏配置表：%s", table.Name))
...
func updateTable(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "update", "gameconf_table", table.ID, fmt.Sprintf("更新游戏配置表：%s", table.Name))
...
func deleteTable(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "delete", "gameconf_table", table.ID, fmt.Sprintf("删除游戏配置表：%s", table.Name))
...
func createExport(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "create", "gameconf_export", export.ID, fmt.Sprintf("创建游戏配置导出：%s - %s", table.Name, export.Format))
...
func deleteExport(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.CreateAdminLog(c, "delete", "gameconf_export", export.ID, fmt.Sprintf("删除游戏配置导出记录：%d", export.ID))
