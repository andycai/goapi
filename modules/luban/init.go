...
func (m *lubanModule) AddAuthRouters() error {
	...
	// api
	app.RouterApi.Get("/luban/projects", app.HasPermission("luban:list"), listProjectsHandler)           // 获取项目列表
	app.RouterApi.Post("/luban/projects", app.HasPermission("luban:create"), createProjectHandler)       // 创建项目
	app.RouterApi.Get("/luban/projects/:id", app.HasPermission("luban:list"), getProjectHandler)         // 获取项目详情
	...
	app.RouterApi.Get("/luban/tables", app.HasPermission("luban:list"), listTablesHandler)           // 获取配置表列表
	app.RouterApi.Post("/luban/tables", app.HasPermission("luban:create"), createTableHandler)       // 创建配置表
	app.RouterApi.Get("/luban/tables/:id", app.HasPermission("luban:list"), getTableHandler)         // 获取配置表详情
	...
	app.RouterApi.Get("/luban/exports", app.HasPermission("luban:list"), getExportsHandler)                     // 获取导出记录列表
	app.RouterApi.Get("/luban/exports/:id", app.HasPermission("luban:list"), getExportHandler)                  // 获取导出记录详情
	app.RouterApi.Get("/luban/exports/progress/:id", app.HasPermission("luban:list"), getExportProgressHandler) // 获取导出进度
