...
func updateServerListHandler(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.WriteLog(c, "update", "serverconf_list", 0, "更新服务器信息配置")
...
func updateLastServerHandler(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.WriteLog(c, "update", "serverconf_last", 0, "更新服务器信息配置")
...
func updateServerInfoHandler(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.WriteLog(c, "update", "serverconf_info", 0, "更新服务器信息配置")
...
func updateNoticeListHandler(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.WriteLog(c, "update", "serverconf_notice", 0, "更新公告列表配置")
...
func updateNoticeNumHandler(c *fiber.Ctx) error {
	...
	// 记录操作日志
	adminlog.WriteLog(c, "update", "serverconf_notice_num", 0, "更新公告数量配置")
