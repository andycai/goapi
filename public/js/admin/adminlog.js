    ...
    return {
        ...
        async fetchLogs() {
            try {
                ...
                const response = await fetch(`/api/admin/adminlog?${params}`);
        ...
        async clearLogs() {
            ...
            try {
                const response = await fetch(`/api/admin/adminlog?beforeDate=${this.searchForm.endDate || new Date().toISOString()}`, {
                    method: 'DELETE'
                });
