    ...
    return {
        ...
        async fetchLogs() {
            try {
                ...
                const response = await fetch(`/api/admin/gamelog?${params}`);
        ...
        async deleteLog(id) {
            ...
            try {
                const response = await fetch(`/api/admin/gamelog/${id}`, {
                    method: 'DELETE'
                });
        ...
        async clearOldData() {
            ...
            try {
                const response = await fetch(`/api/admin/gamelog/before?date=${this.filters.endDate}`, {
                    method: 'DELETE'
                });
